...
{
	public class DateTimeWithoutKindPackRatTests
	{
		...
		public void PackModel_ShouldThrowWhenWriterIsNull()
		{
			...
			DateTimeWithoutKindPackRat packRat = new DateTimeWithoutKindPackRat(piedPiper);
		...
		{
			PiedPiper piedPiper = new PiedPiper();
			PackRat<DateTime> packRat = new DateTimeWithoutKindPackRat(piedPiper);
