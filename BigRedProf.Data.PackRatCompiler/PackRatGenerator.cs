...
namespace BigRedProf.Data.PackRatCompiler
{
	...
	public class PackRatGenerator
	{
		...
		public void GeneratePackRat(Stream inputModelStream, Stream outputPackRatStream, string filePath)
		{
			...
			SourceProject sourceFile = new SourceProject(_compilationContext, filePath);
		...
		private void WriteFile(SourceProject sourceFile, CSharpWriter writer)
		{
		...
		private void WritePackRatClass(SourceProject sourceFile, ClassDeclarationSyntax modelClass, CSharpWriter writer)
		{
