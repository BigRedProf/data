...
namespace BigRedProf.Data.Test.PackRats
{
	public class TokenPackRatTests
	{
		...
		public void PackModel_ShouldWork()
		{
			...
			tokenizer.DefineToken(new Code("0100"), "Michigan Wolverines");
			tokenizer.DefineToken(new Code("0101"), "Michigan State Spartans");
			...
			tokenizer.DefineToken(new Code("1010"), "Penn State Nittany Lions");
			tokenizer.DefineToken(new Code("1011"), "Purdue Boilermakers");
			tokenizer.DefineToken(new Code("1100"), "Rutgers Scarlet Knights");
			tokenizer.DefineToken(new Code("1101"), "UCLA Bruins");
			tokenizer.DefineToken(new Code("1110"), "USC Trojans");
			tokenizer.DefineToken(new Code("1111"), "Wisconsin Badgers");
			...
			PackRatTestHelper.TestPackModel<TokenizedModel<string>>(
				packRat,
				new TokenizedModel<string> { Token = new Code("0100"), Model = "Michigan Wolverines" },
				"11 000000 0100"
			);
			PackRatTestHelper.TestPackModel<TokenizedModel<string>>(
				packRat,
				new TokenizedModel<string> { Token = new Code("0101"), Model = "Michigan State Spartans" },
				"11 000000 0101"
			);
			PackRatTestHelper.TestPackModel<TokenizedModel<string>>(
				packRat,
			...
			PackRatTestHelper.TestPackModel<TokenizedModel<string>>(
				packRat,
				new TokenizedModel<string> { Token = new Code("1010"), Model = "Penn State Nittany Lions" },
				"11 000000 1010"
			);
			PackRatTestHelper.TestPackModel<TokenizedModel<string>>(
				packRat,
				new TokenizedModel<string> { Token = new Code("1011"), Model = "Purdue Boilermakers" },
				"11 000000 1011"
			);
			PackRatTestHelper.TestPackModel<TokenizedModel<string>>(
				packRat,
				new TokenizedModel<string> { Token = new Code("1100"), Model = "Rutgers Scarlet Knights" },
				"11 000000 1100"
			);
			PackRatTestHelper.TestPackModel<TokenizedModel<string>>(
				packRat,
				new TokenizedModel<string> { Token = new Code("1101"), Model = "UCLA Bruins" },
				"11 000000 1101"
			);
			PackRatTestHelper.TestPackModel<TokenizedModel<string>>(
				packRat,
				new TokenizedModel<string> { Token = new Code("1110"), Model = "USC Trojans" },
				"11 000000 1110"
			);
			PackRatTestHelper.TestPackModel<TokenizedModel<string>>(
				packRat,
				new TokenizedModel<string> { Token = new Code("1111"), Model = "Wisconsin Badgers" },
				"11 000000 1111"
			);
		}
